...
const FoundationsIndex: FC = () => {
  return (
    <>
      <Container title={'Foundations'}></Container>
      <h1>Foundations</h1>
      <p>
        In this section you will find the foundations of dall'Agocchie's system,
        including the properties of the sword, how to hold it, the directions,
        the steps, and the definition and theory of tempi.
      </p>
    </>
  );
};
